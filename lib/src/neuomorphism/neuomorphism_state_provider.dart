...
import './neuomorphism_state.dart';
import './functions.dart';

class NeuomorphismStateProvider extends StatefulWidget {
  final Widget child;
  final NeuomorphismState state;

  const NeuomorphismStateProvider({
    Key? key,
    required this.state,
    required this.child,
  }) : super(key: key);

  static NeuomorphismStateProviderState of(BuildContext context) {
    return context
  ...
  @override
  NeuomorphismStateProviderState createState() =>
      NeuomorphismStateProviderState();
}

class NeuomorphismStateProviderState extends State<NeuomorphismStateProvider> {
  late NeuomorphismState state;
...
class _InheritedStateContainer extends InheritedWidget {
  final NeuomorphismStateProviderState data;
